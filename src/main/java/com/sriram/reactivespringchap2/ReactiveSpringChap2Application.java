package com.sriram.reactivespringchap2;
...
public class ReactiveSpringChap2Application implements AsyncConfigurer {

	public static void main(String[] args) {
		SpringApplication.run(ReactiveSpringChap2Application.class, args);
	}
